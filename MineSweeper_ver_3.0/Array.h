...
int LevelDecide_A(level){
    switch (level) {
        case 1:
        mapsizex_ex = 9, mapsizey_ex = 9, bombnum_ex = 10;
        Coordinatex_ex = 365, Coordinatey_ex = 215;
        break;

        case 2:
        mapsizex_ex = 16, mapsizey_ex = 9, bombnum_ex = 22;
        Coordinatex_ex = 260,  Coordinatey_ex = 215;
        break;

        case 3:
        mapsizex_ex = 20, mapsizey_ex = 20, bombnum_ex = 70;
        Coordinatex_ex = 200, Coordinatey_ex = 50;
        break;

        case 4:
        mapsizex_ex = 30, mapsizey_ex = 20, bombnum_ex = 110;
